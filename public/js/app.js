...
let imgVisitingCardList = [
    { id: 1, srcImg: 'public/img/Visiting_Card/1.jpg', title: 'mahdi abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' },
    { id: 2, srcImg: 'public/img/Visiting_Card/2.jpg', title: 'ali abbasi', subTitle: 'Lorem ipsum dolor sit' },
    { id: 3, srcImg: 'public/img/Visiting_Card/3.jpg', title: 'reza abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' },
    { id: 4, srcImg: 'public/img/Visiting_Card/4.jpg', title: 'alireza abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' },
    { id: 5, srcImg: 'public/img/Visiting_Card/5.jpg', title: 'adfd abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' },
    { id: 6, srcImg: 'public/img/Visiting_Card/6.jpg', title: 'mxcvfi abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' },
    { id: 7, srcImg: 'public/img/Visiting_Card/7.jpg', title: 'mah]gg abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' },
    { id: 8, srcImg: 'public/img/Visiting_Card/8.jpg', title: 'adfd abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' },
    { id: 9, srcImg: 'public/img/Visiting_Card/9.jpg', title: 'adfd abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' },
    { id: 10, srcImg: 'public/img/Visiting_Card/10.jpg', title: 'adfd abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' },
    { id: 11, srcImg: 'public/img/Visiting_Card/11.jpg', title: 'adfd abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' },
    { id: 12, srcImg: 'public/img/Visiting_Card/12.jpg', title: 'adfd abbasi', subTitle: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam explicabo voluptates accusantium iure necessitatibus magni voluptatem, mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae unde?' }
]
// todo 
...
let imgBannerCardList = [
    { id: 1, srcImg: 'public/img/instagram-stories-template-with-online-shopping_23-2148545458.jpg', name: 'ali', content: 'lorem hello world lorem hello world lorem hello world' },
    { id: 2, srcImg: 'public/img/instagram-stories-template-with-online-shopping_23-2148545458.jpg', name: 'mahdi', content: 'lorem hello world lorem hello world lorem hello world' },
    { id: 3, srcImg: 'public/img/instagram-stories-template-with-online-shopping_23-2148545458.jpg', name: 'amir', content: 'lorem hello world lorem hello world lorem hello world' },
    { id: 4, srcImg: 'public/img/instagram-stories-template-with-online-shopping_23-2148545458.jpg', name: 'reza', content: 'lorem hello world lorem hello world lorem hello world' }
]

let imgPostCardList = [
    { id: 1, srcImg: 'public/img/flat-design-teacher-s-day-template_23-2150254244.jpg', name: 'ali', content: 'lorem hello world lorem hello world lorem hello world' },
    { id: 2, srcImg: 'public/img/flat-design-teacher-s-day-template_23-2150254244.jpg', name: 'mahdi', content: 'lorem hello world lorem hello world lorem hello world' },
    { id: 3, srcImg: 'public/img/flat-design-teacher-s-day-template_23-2150254244.jpg', name: 'amir', content: 'lorem hello world lorem hello world lorem hello world' },
    { id: 4, srcImg: 'public/img/flat-design-teacher-s-day-template_23-2150254244.jpg', name: 'reza', content: 'lorem hello world lorem hello world lorem hello world' }
]
    ...
    box.addEventListener('click', (event) => {
        ...
        if (box.classList[0] === 'three') {
            let saveSrcImgMain = imgModalLogoList.three.filter((src) => {
                return src.srcImg === 'public/img/LogoSample/01/one-03.jpg';
            })
