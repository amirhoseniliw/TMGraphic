...
<body style="font-family: fa-font;">
    <div class="position-absolute h-100 background_color position-absolute w-100" style="height: max-content !important;">
       <?php
       

       require_once(BASE_PATH . '/template/layouts/header.php');
        ...
        <main class="text-light">
                ...
                <div class="modal-dialog modal-dialog-centered modal_lg_one modal-dialog-scrollable">
                    <div class="modal-content background_color_two">
                        <div class="modal-header py-2" style="border-color: #c2c2c276;">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">درباره ما</h1>
                                            ...
                                            <div class="row row-gap-3">
                                                <div class="col-4 d-flex justify-content-center align-items-center">
                                                    <div class="d-flex justify-content-center align-items-center img_size_soecial">
                                                        <img src="public/icon/icons8-photoshop-96.png" style="width: 100%;"  alt="">
                                                    </div>
                                                </div>
                                                <div class="col-4 d-flex justify-content-center align-items-center">
                                                    <div class="d-flex justify-content-center align-items-center img_size_soecial">
                                                        <img src="public/img/icon/icons8-illustrator-96.png" style="width: 100%;"  alt="">
                                                    </div>
                                                </div>
                                                <div class="col-4 d-flex justify-content-center align-items-center">
                                                    <div class="d-flex justify-content-center align-items-center img_size_soecial">
                                                        <img src="public/img/icon/icons8-photoshop-96.png" style="width: 100%;"  alt="">
                                                    </div>
                                                </div>
                                                <div class="col-4 d-flex justify-content-center align-items-center">
                                                    <div class="d-flex justify-content-center align-items-center img_size_soecial">
                            ...
                            <div class="col-xl-3 col-lg-4 col-12 py-3 background_color_two">
                                <div class="modal-body body_size">
                                    <div
                                        ...
                                        <span id="sub_title_banner" class="fs_sub_title_modal sub_title_modla lh-lg">Lorem
                            ...
                            <div class="col-xl-3 col-lg-4 col-12 py-3 background_color_two">
                                <div class="modal-body body_size">
                                    <div
                                        ...
                                        <span id="sub_title_post" class="fs_sub_title_modal sub_title_modla lh-lg">Lorem
                                            ipsum dolor sit amet consectetur, adipisicing elit. Possimus fugit ipsam
                                            explicabo voluptates accusantium iure necessitatibus magni voluptatem,
                                            mollitia eaque provident magnam nam doloribus rem quia quis suscipit beatae
                                            unde?</span>
            ...
            <div id="Photomontage" class="Photomontage position-relative container-lg container-fluid mt-5">
                <div class="" data-aos="fade-up">
                    ...
                    <button class="title_text_hover" style="font-family: fa-font;" data-text="Awesome" dir="ltr">
                        <span class="actual-text">&nbsp;فتومونتاژ&nbsp;</span>
                        <span aria-hidden="true" class="hover-text">&nbsp;فتومونتاژ&nbsp;</span>
                    </button>
                    <p class="fs-5 sub_text text-light-50">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است،</p>
                </div>
            ...
            <div id="visiting_card" class="visiting_card mt-5 container-lg container-fluid">
                <div class="d-flex flex-row justify-content-between align-items-center" data-aos="fade-up">
                    <div class="title_visiting_card">
                        ...
                        <button class="title_text_hover" style="font-family: fa-font;" data-text="Awesome" dir="ltr">
                            <span class="actual-text">&nbsp;کارت&nbsp;ویزیت&nbsp;</span>
                            <span aria-hidden="true" class="hover-text">&nbsp;کارت&nbsp;ویزیت&nbsp;</span>
                        </button>
                        <p class="fs-5 sub_text text-light-50">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است،</p>
                    </div>
                </div>
            ...
            <div id="Banners" class="Banners mt-5 container-lg container-fluid">
                ...
                <div class="d-flex py-4 flex-row justify-content-between align-items-center" data-aos="fade-up">
                    <div class="title_visiting_card">
                        ...
                        <button class="title_text_hover" style="font-family: fa-font;" data-text="Awesome" dir="ltr">
                            <span class="actual-text">&nbsp;بنرها&nbsp;</span>
                            <span aria-hidden="true" class="hover-text">&nbsp;بنرها&nbsp;</span>
                        </button>
                        <p class="fs-5 sub_text text-light-50">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است،</p>
                    </div>
                    <div class="btn_view_ankings d-sm-flex d-none">
                        <a href="<?= url('bannerPage')?>"
                            ...
                            <span class=" fs_btn_creators">موارد بیشتر</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="btn_view_ankings d-sm-none d-flex">
                    <a href="<?= url('bannerPage')?>" class="btn_see_more text-decoration-none px-4 py-3 rounded-4 d-flex align-items-center w-100 mt-5">
            ...
            <div id="Posts" class="Posts mt-5 container-lg container-fluid">
                <div class="d-flex py-4 flex-row justify-content-between align-items-center" data-aos="fade-up">
                    <div class="title_visiting_card">
                        <!-- <span class="fs-2 title_sub_text">Browse Categories</span> -->
                        <button class="title_text_hover" style="font-family: fa-font;" data-text="Awesome" dir="ltr">
                            <span class="actual-text">&nbsp;استوری&nbsp;ها&nbsp;</span>
                            <span aria-hidden="true" class="hover-text">&nbsp;استوری&nbsp;ها&nbsp;</span>
                        </button>
                        <p class="fs-5 sub_text text-light-50">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است،</p>
                    </div>
                    <div class="btn_view_ankings d-sm-flex d-none">
                ...
                <div class="btn_view_ankings d-sm-none d-flex">
                    <a href="<?= url('postPage')?> " class="btn_see_more text-decoration-none px-4 py-3 rounded-4 d-flex align-items-center w-100 mt-5">
                        <div class="mx-auto d-flex justify-content-center align-items-center column-gap-3">
                            <img src="public/img/icon/RocketLaunch.png" class="fs_icon_btn_creators" alt="">
                            <span class=" fs_btn_creators">موارد بیشتر</span>
                        </div>
            ...
            <div id="Logos" class="Logos mt-5 container-lg container-fluid">
                <div class="d-flex flex-row justify-content-between align-items-center" data-aos="fade-up">
                    <div class="title_visiting_card_2">
                        ...
                        <button class="title_text_hover" style="font-family: fa-font;" data-text="Awesome" dir="ltr">
                            <span class="actual-text">&nbsp;لوگوها&nbsp;</span>
                            <span aria-hidden="true" class="hover-text">&nbsp;لوگوها&nbsp;</span>
                        </button>
                        <p class="fs-5 sub_text text-light-50">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است،</p>
                    </div>
                </div>
       ...
       require_once(BASE_PATH . '/template/layouts/footer.php');
