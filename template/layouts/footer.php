<footer id="about_TM" class="background_color_two py-5 mt-5">
            <div class="row container-lg container-fluid mx-auto">
                <div class="col-12 col-lg-4 mt-lg-0 mt-5">
                    <div class="px-xl-4 px-0">
                        <a href="#header_content" class="navbar-brand text-light d-flex align-items-center column-gap-2">
                ...
                <div class="col-12 col-lg-3 mt-lg-0 mt-5">
                    <div class="px-xl-4 px-0">
                        ...
                        <ul class="list-group mt-4 row-gap-3">
                            <li class="list-unstyled text_shadow_footer_fs">
                                <a href="#Photomontage" class="text-decoration-none fs-6 text-light-50">فتومونتاژ</a>
                            </li>
                            <li class="list-unstyled text_shadow_footer_fs">
                                <a href="#visiting_card" class="text-decoration-none fs-6 text-light-50">کارت ویزیت</a>
                            </li>
                            <li class="list-unstyled text_shadow_footer_fs">
                                <a href="#Banners" class="text-decoration-none fs-6 text-light-50">ینرها</a>
                            </li>
                            <li class="list-unstyled text_shadow_footer_fs">
                                <a href="#Posts" class="text-decoration-none fs-6 text-light-50">استوری ها</a>
                            </li>
                            <li class="list-unstyled text_shadow_footer_fs">
                                <a href="#Logos" class="text-decoration-none fs-6 text-light-50">لوگوها</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <a href="<?= url('EN') ?>" class="wrapper position-fixed">
