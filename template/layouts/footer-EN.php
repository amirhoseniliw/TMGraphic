                ...
                <div class="col-12 col-lg-4 mt-lg-0 mt-5">
                    <div class="px-xl-4 px-0">
                        <a class="navbar-brand text-light d-flex align-items-center column-gap-2">
                            <img src="public/img/Logos/Logo.png" width="45" class="logo_size" alt="">
                ...
                <div class="col-12 col-lg-3 mt-lg-0 mt-5">
                    <div class="px-xl-4 px-0">
                        ...
                        <ul class="list-group mt-4 row-gap-3">
                            <li class="list-unstyled text_shadow_footer">
                                <a href="#Photomontage" class="text-decoration-none fs-6 text-light-50">Photomontage</a>
                            </li>
                            <li class="list-unstyled text_shadow_footer">
                                <a href="#visiting_card" class="text-decoration-none fs-6 text-light-50">Visiting
                                    card</a>
                            </li>
                            <li class="list-unstyled text_shadow_footer">
                                <a href="#Banners" class="text-decoration-none fs-6 text-light-50">Banners</a>
                            </li>
                            <li class="list-unstyled text_shadow_footer">
                                <a href="#Posts" class="text-decoration-none fs-6 text-light-50">Storys</a>
                            </li>
                            <li class="list-unstyled text_shadow_footer">
                                <a href="#Logos" class="text-decoration-none fs-6 text-light-50">Logos</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <li class="list-unstyled">
                                <form class="input-group d-sm-flex d-none mt-4">
                                    ...
                                    <button
                                        ...
                                        <img src="public/img/icon/EnvelopeSimple.png" width="20" alt="">
                                        <span>Subscribe</span>
                                    </button>
                                </form>
