...
<body class="background_color" style="font-family: fa-font;">
...
<header class="">
        ...
        <nav class="navbar_bg navbar navbar-expand-xl position-fixed w-100 px-xl-5 px-3 d-flex align-items-center justify-content-between py-4" style="z-index: 20;">
            <a href="<?= url(' ')?>" class="navbar-brand text-light d-flex justify-content-center align-items-center column-gap-2">
            ...
            <ul class="navbar-nav d-none d-sm-none d-xl-flex flex-row-reverse column-gap-5">
                <li class="nav-item">
                    <a href=" <?= url(' ')?>" class="btn_link_header text-decoration-none px-3 py-2">لوگوها</a>
                </li>
                <li class="nav-item">
                    <a href=" <?= url(' ')?>" class="btn_link_header text-decoration-none px-3 py-2">استوری ها</a>
                </li>
                <li class="nav-item">
                    <a href=" <?= url(' ')?>" class="btn_link_header text-decoration-none px-3 py-2">بنرها</a>
                </li>
                <li class="nav-item">
                    <a href=" <?= url(' ')?>" class="btn_link_header text-decoration-none px-3 py-2">کارت ویزیت</a>
                </li>
                <li class="nav-item">
                    <a href=" <?= url(' ')?>" class="btn_link_header text-decoration-none px-3 py-2">فتومونتاژ</a>
                </li>
            </ul>
            ...
            <div class="offcanvas offcanvas-start d-xl-none d-flex d-sm-flex px-3 offcanvas-box" id="offcanvas-box"
                ...
                <ul class="navbar-nav d-flex row-gap-2 d-sm-flex d-xxl-none column-gap-3 flex-column-reverse">
                    <li class="nav-item">
                        <a href=" <?= url(' ')?>" data-bs-target="#aboutModal" data-bs-toggle="modal" class="d-flex btn_about text-light px-2 py-2 text-decoration-none rounded-2">درباره ما</a>
                    </li>
                    <hr style="width: 80%;" class="mx-auto shadow">
                    <li class="nav-item">
                        <a href=" <?= url(' ')?>" class="nav-link text-light rounded-3 px-2">لوگو</a>
                    </li>
                    <li class="nav-item">
                        <a href=" <?= url(' ')?>" class="nav-link text-light rounded-3 px-2 active">استوری ها</a>
                    </li>
                    <li class="nav-item">
                        <a href=" <?= url(' ')?>" class="nav-link text-light rounded-3 px-2 active">بنرها</a>
                    </li>
                    <li class="nav-item">
                        <a href=" <?= url(' ')?>" class="nav-link text-light rounded-3 px-2">کارت ویزیت</a>
                    </li>
                    <li class="nav-item">
                        <a href=" <?= url(' ')?>" class="nav-link text-light rounded-3 px-2 active">فتومونتاژ</a>
                    </li>
                </ul>
            </div>
        </nav>
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="d-flex justify-content-center align-items-center flex-column row-gap-2">
                                <div class="logo_box_about">
                                    <img src="img/icon/Storefront.png" width="200" alt="">
                                </div>
        ...
        <div class="row container-lg container-fluid mx-auto">
            <div class="col-12 col-lg-4 mt-lg-0 mt-5">
                <div class="px-xl-4 px-0">
                    <a href="<?= url(" ")?></a>" class="navbar-brand text-light d-flex align-items-center column-gap-2">
                    ...
                    <ul class="list-group mt-4 row-gap-4">
                        <li class="list-unstyled text_shadow_footer_fs">
                            <span class="text-decoration-none fs-6 text-light-50">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است</span>
                        </li>
                        <li class="list-unstyled text_shadow_footer_fs">
                            <span class="text-decoration-none fs-6 text-light-50">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است</span>
                        </li>
                        <li class="list-unstyled d-flex flex-row column-gap-3">
                            <a href="https://t.me/Mahdi_abbasi0" class="text-decoration-none fs-5 text-light-50">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" class="tel_shadow" shape-rendering="geometricPrecision"
                            ...
                            <a href="https://www.linkedin.com/in/abbasiimahdi" class="text-decoration-none fs-5 text-light-50">
                                <svg id="Layer_1" width="40" class="linkedin_shadow" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a href="https://www.instagram.com/mahdi.marandi.orginal?igsh=Y2d4bTZpbjZoNzZ2" class="text-decoration-none fs-5 text-light-50">
                                <svg xmlns="http://www.w3.org/2000/svg" width="40" class="ins_shadow" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 132.004 132">
                                    <defs>
                                        <linearGradient id="b">
            ...
            <div class="col-12 col-lg-3 mt-lg-0 mt-5">
                <div class="px-xl-4 px-0">
                    <div>
                        <span class="fs-3 text-light">نمونه کارها</span>
                    </div>
                    <ul class="list-group mt-4 row-gap-3">
                        <li class="list-unstyled text_shadow_footer_fs">
                            <a href=" <?= url(' ')?>" class="text-decoration-none fs-6 text-light-50">فتومونتاژ</a>
                        </li>
                        <li class="list-unstyled text_shadow_footer_fs">
                            <a href=" <?= url(' ')?>" class="text-decoration-none fs-6 text-light-50">کارت ویزیت</a>
                        </li>
                        <li class="list-unstyled text_shadow_footer_fs">
                            <a href=" <?= url(' ')?>" class="text-decoration-none fs-6 text-light-50">ینرها</a>
                        </li>
                        <li class="list-unstyled text_shadow_footer_fs">
                            <a href=" <?= url(' ')?>" class="text-decoration-none fs-6 text-light-50">استوری ها</a>
                        </li>
                        <li class="list-unstyled text_shadow_footer_fs">
                            <a href=" <?= url(' ')?>" class="text-decoration-none fs-6 text-light-50">لوگوها</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <script src="<?=asset('public/js/postPage-fs.js')?>"></script>
</body>
</html>